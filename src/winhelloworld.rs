...
impl HelloWorld {
    pub fn new<P: CastInto<Ptr<QWidget>>>(parent: P) -> Rc<Self> {
    ...
    pub unsafe fn get_ocr_text_from_json2(self: &Rc<Self>, values: &Vec<Root>) -> String {
    ...
    #[slot(SlotNoArgs)]
    pub unsafe fn on_add_clicked(self: &Rc<Self>) {
